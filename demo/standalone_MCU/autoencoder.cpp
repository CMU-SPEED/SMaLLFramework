...
dtype * inference(uint32_t layer_num_total, uint16_t layer_params[30][10], dtype * filter_ptrs[30], dtype *input_dc, dtype *inter_0_dc, dtype *inter_1_dc)
{
    int layer_num = 0;
...
int main(int argc, char **argv)
{
    ...
    output_dc = inference(layer_num_total, layer_params, filter_ptrs, input_dc, inter_0_dc, inter_1_dc);
    ...
    //     inference(layer_num_total, layer_params, filter_ptrs, input_dc, inter_0_dc, inter_1_dc, output_dc);
