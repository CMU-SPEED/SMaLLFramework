...
void fused_abstract_layer(
    ...
    BufferT * /*__restrict__*/ O)
{
    // constexpr dim_t  _G_b           = MappingParams_0::_G_b          ;
    // constexpr dim_t  _K_b           = MappingParams_0::_K_b          ;
    // constexpr dim_t  _F_cb          = MappingParams_0::_F_cb         ;
    // constexpr dim_t  _O_wb          = MappingParams_0::_O_wb         ;
    // constexpr dim_t  _stride        = MappingParams_0::_stride       ;
    // constexpr dim_t  _UNROLL        = MappingParams_0::_UNROLL       ;
    // constexpr OpType op_type        = MappingParams_0::op_type       ;
    // constexpr int8_t op_class       = MappingParams_0::op_class      ;     //  2  (conv),  1  (dense,pool), or '0' (activation, upsample)
    // constexpr bool   rewrite_output = MappingParams_0::rewrite_output;
