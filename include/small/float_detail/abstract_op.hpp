...
#define FLOAT_ABSTRACT_OP(step, op_type, op_class, a_cur, b_cur, O_wb, C_ob) \
    ...
    {                                                                   \
        FLOAT_SQRT_TILE_C(step, a_cur, O_wb, C_ob);                     \
    }                                                                   \
    else if constexpr (op_type == OP_MUL)                               \
    {                                                                   \
        FLOAT_MUL_TILE_C(step, a_cur, O_wb, C_ob);                      \
    }                                                                   \
    else if constexpr (op_type == OP_SIGN)                              \
    {                                                                   \
        FLOAT_SIGN_TILE_C(step, a_cur, O_wb, C_ob);                     \
    }                                                                   \
    else if constexpr (op_type == OP_NSIGN)                             \
    {                                                                   \
        FLOAT_NSIGN_TILE_C(step, a_cur, O_wb, C_ob);                    \
    }                                                                   \
    else if constexpr (op_type == OP_SUB)                               \
    {                                                                   \
        FLOAT_SUB_TILE_C(step, a_cur, O_wb, C_ob);                      \
    }                                                                   \
    else if constexpr (op_type == OP_COND_NSIGN)                         \
    {                                                                   \
        FLOAT_COND_NSIGN_TILE_C(step, a_cur, O_wb, C_ob);                \
    }                                                                                                        
...
#define FLOAT_ABSTRACT_OP_END(step, op_type, op_class, a_cur, b_cur, c_cur, W_elements, C_ob) \
    ...
    {                                                                         \
        FLOAT_SQRT_END_C(step, a_cur, c_cur, W_elements, C_ob);               \
    }                                                                         \
    else if constexpr (op_type == OP_MUL)                                     \
    {                                                                         \
        FLOAT_MUL_END_C(step, a_cur, c_cur, W_elements, C_ob);                \
    }                                                                         \
    else if constexpr (op_type == OP_SIGN)                                    \
    {                                                                         \
        FLOAT_SIGN_END_C(step, a_cur, c_cur, W_elements, C_ob);               \
    }                                                                         \
    else if constexpr (op_type == OP_NSIGN)                                   \
    {                                                                         \
        FLOAT_NSIGN_END_C(step, a_cur, c_cur, W_elements, C_ob);              \
    }                                                                         \
    else if constexpr (op_type == OP_SUB)                                     \
    {                                                                         \
        FLOAT_SUB_END_C(step, a_cur, c_cur, W_elements, C_ob);                \
    }                                                                         \
    else if constexpr (op_type == OP_COND_NSIGN)                               \
    {                                                                         \
        FLOAT_COND_NSIGN_END_C(step, a_cur, c_cur, W_elements, C_ob);          \
    }
