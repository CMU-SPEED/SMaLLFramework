...
a_2 = vld1q_dup_f32(a + 2 * step + 0 * SIMD);\
...
a_3 = vld1q_dup_f32(a + 3 * step + 0 * SIMD);\
...
a_4 = vld1q_dup_f32(a + 4 * step + 0 * SIMD);\
...
a_5 = vld1q_dup_f32(a + 5 * step + 0 * SIMD);\
...
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[0]" : "+w"(c_5_0) : "w"(b_0), "w"(a_5));\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[0]" : "+w"(c_5_1) : "w"(b_1), "w"(a_5));\
b_0 = vld1q_f32(bb + 0*C_ob + (0 * 4 + 2)*SIMD);			\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[0]" : "+w"(c_0_2) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 0*C_ob + (0 * 4 + 3)*SIMD);\
...
\
b_0 = vld1q_f32(bb + 1*C_ob + (0 * 4 + 0)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[1]" : "+w"(c_0_0) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 1*C_ob + (0 * 4 + 1)*SIMD);\
...
b_0 = vld1q_f32(bb + 1*C_ob + (0 * 4 + 2)*SIMD);			\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[1]" : "+w"(c_0_2) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 1*C_ob + (0 * 4 + 3)*SIMD);\
...
\
b_0 = vld1q_f32(bb + 2*C_ob + (0 * 4 + 0)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[2]" : "+w"(c_0_0) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 2*C_ob + (0 * 4 + 1)*SIMD);\
...
b_0 = vld1q_f32(bb + 2*C_ob + (0 * 4 + 2)*SIMD);			\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[2]" : "+w"(c_0_2) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 2*C_ob + (0 * 4 + 3)*SIMD);\
...
\
b_0 = vld1q_f32(bb + 3*C_ob + (0 * 4 + 0)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[3]" : "+w"(c_0_0) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 3*C_ob + (0 * 4 + 1)*SIMD);\
...
b_0 = vld1q_f32(bb + 3*C_ob + (0 * 4 + 2)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[3]" : "+w"(c_0_2) : "w"(b_0), "w"(a_0));\
b_1 = vld1q_f32(bb + 3*C_ob + (0 * 4 + 3)*SIMD);\
