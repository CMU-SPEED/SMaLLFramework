...
#pragma omp parallel for
  ...
  for (uint32_t j = 0; j < C; j += C_ob)
  {
    ...
    float *F_ptr = F + (j/C_ob) * pool_H_f * pool_W_f * C_ob;
...
// 			for (uint32_t k = 0; k < W_o_pool; k += W_ob_pool)
// 			{
// 				row_dw_kernel<pool_stride * C_ob, pool_stride, pool_H_f, pool_W_f>(O_conv_ptr, l, k, F_ptr, pool_col_stride, O_pool_ptr, H_o);
// 				O_conv_ptr += pool_stride*W_ob*C_ob;
// 			}
// 			row_dw_kernel_end<pool_stride * C_ob, pool_stride, pool_H_f, pool_W_f>(O_conv_ptr, l, W_o_pool, F_ptr, pool_col_stride, O_pool_ptr, H_o, W_last);
// 		}
// 	}
// }
