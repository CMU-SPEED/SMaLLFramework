...
b_2 = vld1q_f32(bb + 1*C_ob + (0 * 4 + 2)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[1]" : "+w"(c_0_2) : "w"(b_2), "w"(a_0));\
b_3 = vld1q_f32(bb + 1*C_ob + (0 * 4 + 3)*SIMD);\
...
b_2 = vld1q_f32(bb + 2*C_ob + (0 * 4 + 2)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[2]" : "+w"(c_0_2) : "w"(b_2), "w"(a_0));\
b_3 = vld1q_f32(bb + 2*C_ob + (0 * 4 + 3)*SIMD);\
...
b_2 = vld1q_f32(bb + 3*C_ob + (0 * 4 + 2)*SIMD);\
__asm__ volatile ("fmla %0.4s, %1.4s, %2.s[3]" : "+w"(c_0_2) : "w"(b_2), "w"(a_0));\
b_3 = vld1q_f32(bb + 3*C_ob + (0 * 4 + 3)*SIMD);\
