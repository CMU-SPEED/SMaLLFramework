...
void test_conv1d_layer_odd_output_channels(void)
{
    ...
    // C_i,H,W,k,s,p,C_o
    LayerParams params {16, 1, 13, 1, 1, small::PADDING_F, 13};
    ...
    try
    {
        ...
        {
            TEST_ASSERT(conv1d.output_shape()[small::CHANNEL] == params.C_o);
        }
        else
        {
            TEST_ASSERT(conv1d.output_shape()[small::CHANNEL] ==
