...
//****************************************************************************
void test_averagepool1d_layer_error(void)
{
    ...
    try
    {
        ...
        small::AveragePool1DLayer<BufferT> averagepool1d(input_shape,
                                                 params.k,
                                                 params.s, params.p);
...
//****************************************************************************
void test_averagepool1d_layer(void)
{
#if defined(QUANTIZED)
    using BufferT = small::QUInt8Buffer;
#else
    ...
    // Test function call
    small::AveragePool1D(params.k, params.s, l_pad, r_pad, channels, 1, params.W,
    ...
    // Test layer class
    small::AveragePool1DLayer<BufferT> averagepool1d(input_shape, params.k, params.s, params.p);
    averagepool1d.compute_output({&packed_input}, &output);

    TEST_ASSERT(averagepool1d.logical_output_channels() == params.C_o);
    TEST_ASSERT(averagepool1d.output_shape()[small::CHANNEL] == channels);
...
//****************************************************************************
void test_averagepool1d_layer_odd_output_channels(void)
{
#if defined(QUANTIZED)
    using BufferT = small::QUInt8Buffer;
#else
    ...
    ScalarT inputs[12]         {1, 3, 2, 4,  1, 3, 2, 4,  1, 3, 2, 4};
    ScalarT expected_output[6] {2,    3,     2,    3,     2,    3};
...
//****************************************************************************
TEST_LIST = {
    {"averagepool1d_layer_error",   test_averagepool1d_layer_error},
    {"averagepool1d_layer",         test_averagepool1d_layer},
    {"averagepool1d_layer_odd_output_channels",
     test_averagepool1d_layer_odd_output_channels},
