...
//****************************************************************************
// Function call implementation of dscnn
//****************************************************************************
...
void build_baseline_dscnn(uint32_t C_i,         // 128, 1, 1, 16(8), ...
                          uint32_t N, // I_h
                          uint32_t M, // I_w
...
void test_dscnn(void)
{
    ...
    build_baseline_dscnn(C_i, N, M, num_classes,
                         layer_num_total,
                         layer_params,
                         intermediate_dims,
                         filter_buf_ptrs,
    ...
    std::vector<double> layer_timing;
    {
        ...
        small::DSCNNTiny<BufferT> model(input_shape,
    ...
    std::vector<double> dag_timing;
    {
        ...
        small::DSCNNTinyDAG<BufferT> model(input_shape,
                                           filter_buf_ptrs, true);
    ...
    print_stats(small_timing, "SMaLL:dscnn Baseline");
    print_stats(layer_timing, "SMaLL:dscnn Layers  ");
    print_stats(dag_timing,   "SMaLL:dscnn DAGModel");
...
//****************************************************************************
TEST_LIST = {
    {"dscnn_data_performance", test_dscnn},
    {NULL, NULL}
};
