...
g++ -O3 -fopenmp -fPIC -march=native -I./include -I${SMALL_ROOT}/include -I${SMALL_ROOT}/include/small ${PLATFORM_FLAGS} --shared ${SMALL_ROOT}/lib/layers.cpp -o ${SMALL_ROOT}/lib/libsmall.so;
